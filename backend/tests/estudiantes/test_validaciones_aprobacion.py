...
from core.models import (
    ...
    RegularidadPlantilla, RegularidadFormato, ActaExamen, ActaExamenEstudiante
)
...
from apps.estudiantes.api.actas import crear_acta_examen, ActaCreateLocal as ActaCreateIn, ActaEstudianteLocal as ActaEstudianteIn
from apps.estudiantes.services.equivalencias_disposicion import registrar_disposicion_equivalencia
