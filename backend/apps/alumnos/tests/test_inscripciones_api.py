...
from apps.alumnos.api.inscripciones_materias_api import (
    inscripcion_materia,
    cancelar_inscripcion_materia,
)
from apps.alumnos.schemas import InscripcionMateriaIn, CancelarInscripcionIn
...
def test_cancelar_inscripcion_materia_changes_state():
    ...
    inscripcion = InscripcionMateriaAlumno.objects.create(
        ...
        estado=InscripcionMateriaAlumno.Estado.PENDIENTE,
    )
    ...
    assert inscripcion.estado == InscripcionMateriaAlumno.Estado.ANULADA
