...
export const INSTITUTIONAL_TERRACOTTA = "#9C4E35";
export const INSTITUTIONAL_TERRACOTTA_DARK = "#7D3D28";
export const INSTITUTIONAL_BEIGE = "#E8DFD3";
export const INSTITUTIONAL_BEIGE_BORDER = "#D6CAA";
