...
export default function PreinscripcionWizard() {
	...
	const pageBgSx = {
		minHeight: "100vh",
		background:
			"radial-gradient(circle at 20% 20%, #f8f1e7 0, #f8f1e7 25%, #f0ede5 40%, #f7f5ef 100%)",
		py: { xs: 3, md: 5 },
		px: { xs: 1.5, md: 3 },
	};
					...
					>
						<Alert severity="info" sx={{ alignItems: "center" }}>
							...
							<Typography variant="body1">
								...
								<a
									href="http://www.ipespaulofreire.edu.ar"
									target="_blank"
									rel="noopener noreferrer"
								>
									www.ipespaulofreire.edu.ar
								</a>{" "}
								o acercate a Estrada 1575, Río Grande, Tierra del Fuego.
							</Typography>
						</Alert>
					</Paper>
				</Stack>
								...
								<Stack spacing={2.5}>
									...
									<Stepper
										...
										sx={{
											...
											"& .MuiStepConnector-line": { borderColor: "#d9d2c6" },
										}}
									>
										{steps.map((label) => (
											<Step key={label}>
